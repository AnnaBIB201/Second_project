...
/// Character
/**
* Хранит 2 координаты как числа с плавающй запятой,значения ширины и высоты как
числа с плавающй запятой,значения смещений по осям как числа с плавающй запятой,
значение счёта как целое число, 2 булевых значения, название файла как строковый
тип данных, изображение, текстуру,спрайт
*/
class Character {
  public:
...
/// Bonus
/**
* Хранит 2 типа объектов как сгруппированный набор,2 координаты как числа с
плавающй запятой,значения ширины и высоты как числа с плавающй запятой, значения
смещений по осям как числа с плавающй запятой, логическое значение, спрайт, тип
объекта
*/
class Bonus {
  public:
